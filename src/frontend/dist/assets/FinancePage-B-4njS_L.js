import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, e as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, f as clsx, R as React2, i as invariant, W as Wallet, T as TrendingUp } from "./index-CeuI7PIL.js";
import { C as Card, B as Button, b as CardHeader, c as CardTitle, d as CardDescription, a as CardContent } from "./Card-DVJtgs4C.js";
...
import { T as TriangleAlert, E as EstimateBadge } from "./EstimateBadge-BwLRuXD6.js";
...
import { u as useFinancialPlan, B as Building2 } from "./useQueries-CxLdcEDA.js";
import { f as formatINR$2 } from "./demo-data-CVHFmdt3.js";
import { c as computeFinancialPlan } from "./api-client-DE3CIaVf.js";
    ...
    Card,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
          ...
          icon ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex size-8 shrink-0 items-center justify-center rounded-full bg-accent/15 text-accent-foreground", children: icon }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat text-2xl font-bold tracking-tight text-foreground", children: value }),
...
function PrincipalInterestChart({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", "data-ocid": "principal_interest_chart", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex flex-wrap items-center gap-4 text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-2.5 rounded-full fin-loan bg-current" }),
        "Principal — ",
        formatINR$1(principalInterest.totalPrincipal)
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-2.5 rounded-full fin-interest bg-current" }),
        "Interest — ",
        formatINR$1(principalInterest.totalInterest)
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      BarChart,
      {
        data,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            YAxis,
            {
              ...
              axisLine: false,
              tick: { fill: "var(--muted-foreground)", fontSize: 11 },
              tickFormatter: (v2) => `₹${Math.round(v2 / 1e3)}k`,
              width: 44
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function RepaymentScheduleTable({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "repay-table min-w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right", children: "Principal" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right", children: "Interest" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right", children: "EMI" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right", children: "Closing" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: schedule.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            "data-ocid": `repay_row.${row.month}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "font-medium text-foreground", children: row.month }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "num text-muted-foreground", children: formatINR(row.openingBalance) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "num fin-loan", children: formatINR(row.principal) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "num fin-interest", children: formatINR(row.interest) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "num font-semibold text-foreground", children: formatINR(row.emi) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "num text-muted-foreground", children: formatINR(row.closingBalance) })
            ]
          },
          `repay-row-${row.month}`
        )) })
...
const DEFAULT_INPUT = {
  proposedProjectCost: 15e5,
  ownCapital: 45e4,
  loanRequirement: 105e4,
  tenureMonths: 60,
  interestRatePercent: 11,
  marginPercent: 25,
  moratoriumMonths: 6,
  ...
  workingCapital: {
    initialRequirement: 1e5,
    monthlyRequirement: 6e4,
    emergencyBufferPercent: 10
  },
  pricePerUnit: 120,
  variableCostPerUnit: 60
};
const OPERATING_COST_FIELDS = [
  { key: "rent", label: "Rent" },
...
function clamp(v2) {
  return Math.max(0, Math.min(100, Math.round(v2)));
}
function computeFeasibility(plan, input) {
  ...
  const financial = clamp(
    100 - loanShare * 40 - Math.min(emiBurden, 1.5) * 30 + Math.min(margin, 40) * 0.5
  );
  ...
  return {
    ...
    explanation: "This score is built from four transparent parts using fixed rules: Financial (how affordable the loan is), Market (your margin as a sign of pricing power), Competition (how much price pressure you face), and Risk (how much of the project you fund yourself). It is a guide, not a guarantee."
  };
}
function FinanceSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "loading_state", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-56 animate-pulse-soft rounded-lg bg-muted" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 lg:grid-cols-4", children: Array.from({ length: 4 }, (_, i) => `metric-${i}`).map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-32 rounded-2xl" }, id)) }),
...
function FinancePage() {
  const [input, setInput] = reactExports.useState(DEFAULT_INPUT);
  const [rule, setRule] = reactExports.useState(SCHEME_RULES[0]);
  ...
  const plan = reactExports.useMemo(
    () => (planResult == null ? void 0 : planResult.data) ?? computeFinancialPlan(input, rule),
    [planResult, input, rule]
  );
  const source = (planResult == null ? void 0 : planResult.source) ?? "demo";
  const feasibility = reactExports.useMemo(
    () => computeFeasibility(plan, input),
    [plan, input]
  );
  const setNumber = (key, value) => setInput((prev) => ({ ...prev, [key]: value }));
  const setOperatingCost = (key, value) => setInput((prev) => ({
    ...prev,
    operatingCosts: { ...prev.operatingCosts, [key]: value }
  }));
  const setWorkingCapital = (key, value) => setInput((prev) => ({
    ...prev,
    workingCapital: { ...prev.workingCapital, [key]: value }
  }));
  const totalOperatingCost = reactExports.useMemo(() => {
    const op = input.operatingCosts;
    return op.rent + op.salary + op.rawMaterial + op.electricity + op.transport + op.packaging + op.marketing + op.maintenance + op.other;
  }, [input.operatingCosts]);
  if (status === "loading") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto w-full max-w-6xl px-4 py-6 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FinanceSkeleton, {}) });
  }
  if (status === "error") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto w-full max-w-6xl px-4 py-6 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
        title: "Couldn't load your financial plan",
        description: "Something went wrong while preparing your plan. Please try again.",
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "size-6" }),
        actionLabel: "Retry",
  ...
  const recommendation = {
    opportunity: `Your margin of ${input.marginPercent}% and a feasible project cost of ${formatINR$2(
      financing.feasibleProjectCost.value
    )} point to a workable business.`,
    risk: emi > 0 && monthlyOperatingCost.value > 0 && emi / monthlyOperatingCost.value > 0.5 ? "Your monthly EMI is more than half your operating cost, so cash flow may be tight." : "Your monthly EMI is within a comfortable share of your operating cost.",
    ...
    nextAction: "Confirm your own contribution and approach the scheme office with your project cost and loan requirement to start the application."
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold tracking-tight sm:text-3xl", children: "Financial Plan" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center rounded-full bg-warning/15 px-2.5 py-1 text-xs font-semibold text-warning", children: source === "backend" ? "Live" : "Estimated" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 max-w-xl text-sm text-muted-foreground", children: "Your project cost, loan, EMI, and break-even — worked out from the numbers you enter below." })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "mt-6", "data-ocid": "inputs_panel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Your plan inputs" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Enter your project details. All figures are worked out from these numbers using fixed rules." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Scheme financing terms" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  value: rule.name,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      SelectTrigger,
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select a scheme" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: SCHEME_RULES.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: r.name, children: r.name }, r.name)) })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                ...
                "% loan,",
                " ",
                rule.interestRatePercent,
                "% interest, ",
                rule.tenureMonths,
                " months,",
                " ",
                rule.moratoriumMonths,
                " month moratorium."
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                InputField,
                {
                  ...
                  onChange: (e3) => setNumber("proposedProjectCost", Number(e3.target.value)),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                InputField,
                {
                  ...
                  onChange: (e3) => setNumber("ownCapital", Number(e3.target.value)),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                InputField,
                {
                  ...
                  onChange: (e3) => setNumber("loanRequirement", Number(e3.target.value)),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                InputField,
                {
                  ...
                  onChange: (e3) => setNumber("interestRatePercent", Number(e3.target.value)),
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator, { className: "size-4" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                InputField,
                {
                  ...
                  onChange: (e3) => setNumber("tenureMonths", Number(e3.target.value)),
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { className: "size-4" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                InputField,
                {
                  ...
                  onChange: (e3) => setNumber("moratoriumMonths", Number(e3.target.value)),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                InputField,
                {
                  ...
                  onChange: (e3) => setNumber("pricePerUnit", Number(e3.target.value)),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                InputField,
                {
                  ...
                  onChange: (e3) => setNumber("variableCostPerUnit", Number(e3.target.value)),
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { className: "size-4" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              WhatIfSlider,
              {
                ...
                max: 60,
                step: 1,
                onChange: (v2) => setNumber("marginPercent", v2),
                format: (v2) => `${v2}%`
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-8", "aria-labelledby": "overview-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Your project at a glance, from the numbers above." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(EstimateBadge, { estimate: monthlyOperatingCost })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    label: "Project cost",
                    value: formatINR$2(financing.feasibleProjectCost.value),
                    category: "capital",
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "size-4" }),
                    hint: "feasible"
                  }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  FinancialMetricCard,
                  {
                    ...
                    value: formatINR$2(financing.beneficiaryContribution.value),
                    category: "money",
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "size-4" }),
                    hint: "your share"
                  }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    label: "Loan",
                    value: formatINR$2(financing.loanAmount.value),
                    category: "loan",
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Landmark, { className: "size-4" }),
                    hint: "from scheme"
                  }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  FinancialMetricCard,
                  {
                    ...
                    value: formatINR$2(totalRepayment),
                    category: "interest",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  FinancialMetricCard,
                  {
                    ...
                    value: formatINR$2(monthlyOperatingCost.value),
                    category: "operating",
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { className: "size-4" }),
                    hint: "per month"
                  }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  FinancialMetricCard,
                  {
                    ...
                    value: formatINR$2(workingCapital.totalRequirement.value),
                    category: "capital",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    label: "Break-even",
                    value: formatINR$2(breakEven.breakEvenSales.value),
                    category: "breakeven",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-8", "aria-labelledby": "emi-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              id: "emi-heading",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "The fixed amount you pay each month to repay the loan." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-8", "aria-labelledby": "schedule-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              id: "schedule-heading",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "How each month's payment splits into principal and interest." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid gap-6 lg:grid-cols-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-5", "data-ocid": "schedule_panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RepaymentScheduleTable, { schedule: amortization.schedule }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-5", "data-ocid": "chart_panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-8", "aria-labelledby": "moratorium-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              id: "moratorium-heading",
              className: "font-display text-lg font-semibold tracking-tight",
              children: "Moratorium (waiting period)"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid gap-4 lg:grid-cols-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5", "data-ocid": "moratorium_panel", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Repayment starts" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "fin-stat mt-1 text-xl font-bold text-foreground", children: [
                    "Month ",
                    moratorium.repaymentStartMonth
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Interest during moratorium" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-xl font-bold fin-interest", children: formatINR$2(moratorium.interestAccruedDuringMoratorium.value) })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-relaxed text-foreground/85", children: moratorium.explanation })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { children: "During the moratorium you do not pay the loan, but interest keeps adding to the amount you owe. So the total you repay later is a little higher. This is normal and is already included in your EMI." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-8", "aria-labelledby": "operating-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              id: "operating-heading",
              className: "font-display text-lg font-semibold tracking-tight",
              children: "Operating cost"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
            "Your monthly running costs. Total: ",
            formatINR$2(totalOperatingCost),
            "."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "mt-4 p-5", "data-ocid": "operating_panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: OPERATING_COST_FIELDS.map((field) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            InputField,
            {
              label: field.label,
              type: "number",
              value: input.operatingCosts[field.key],
              onChange: (e3) => setOperatingCost(field.key, Number(e3.target.value)),
              "data-ocid": `operating_${field.key}_input`
            },
            field.key
          )) }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-8", "aria-labelledby": "working-capital-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "The money you need to keep the business running day to day." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid gap-4 lg:grid-cols-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5", "data-ocid": "working_capital_panel", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid grid-cols-3 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Initial" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-sm font-semibold", children: formatINR$2(workingCapital.initialRequirement.value) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Monthly" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-sm font-semibold", children: formatINR$2(workingCapital.monthlyRequirement.value) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Buffer" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-sm font-semibold", children: formatINR$2(workingCapital.emergencyBuffer.value) })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center justify-between rounded-xl bg-muted/40 p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Total requirement" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat text-lg font-bold text-foreground", children: formatINR$2(workingCapital.totalRequirement.value) })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { children: "Working capital is the money you need to buy stock, pay salaries, and cover daily costs before your sales bring money in. The buffer is an extra amount kept aside for emergencies, like a bad month or a sudden repair." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-8", "aria-labelledby": "breakeven-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid gap-4 lg:grid-cols-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5", "data-ocid": "breakeven_panel", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Break-even sales" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-xl font-bold fin-breakeven", children: formatINR$2(breakEven.breakEvenSales.value) })
                ] }),
                breakEven.breakEvenUnits ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Break-even units" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-xl font-bold text-foreground", children: Math.round(breakEven.breakEvenUnits.value) })
                ] }) : null
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-relaxed text-foreground/85", children: breakEven.explanation }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground", children: "Assumptions" }),
                breakEven.assumptions.map((a2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
                  "• ",
                  a2
                ] }, a2))
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { children: "Break-even is the sales level where your income just covers all your costs — you neither make a profit nor a loss. Sell more than this and you start earning profit. It helps you know how much you must sell each month to stay safe." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-8", "aria-labelledby": "feasibility-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FeasibilityScoreRing, { score: feasibility }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-8", "aria-labelledby": "recommendation-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "mt-4 p-6", "data-ocid": "recommendation_panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Feasibility" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "fin-stat mt-1 text-xl font-bold text-gradient", children: [
                feasibility.overall,
                "/100"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Opportunity" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-foreground/85", children: recommendation.opportunity })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Risk" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-foreground/85", children: recommendation.risk })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Investment" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-lg font-bold", children: formatINR$2(recommendation.investment) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Project cost" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-lg font-bold", children: formatINR$2(recommendation.projectCost) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Own contribution" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-lg font-bold", children: formatINR$2(recommendation.ownContribution) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Loan" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-lg font-bold", children: formatINR$2(recommendation.loan) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Potential scheme" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm font-medium text-foreground", children: recommendation.potentialScheme })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "EMI" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-lg font-bold", children: formatINR$2(recommendation.emi) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Working capital" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fin-stat mt-1 text-lg font-bold", children: formatINR$2(recommendation.workingCapital) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4 sm:col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Next action" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-foreground/85", children: recommendation.nextAction })
            ] })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-8", "aria-labelledby": "explain-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              id: "explain-heading",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { title: "Margin", children: "Margin is the share of each sale you keep after paying for raw material, rent, salaries, and other costs. A higher margin means you keep more from every rupee you earn." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { title: "Project cost", children: "Project cost is the total money needed to set up your business — buying machines, stock, and getting things ready. It is the full amount your plan is built around." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { title: "Loan", children: "A loan is money a bank or scheme gives you that you must pay back with interest. You do not own this money — it is borrowed, and your EMI pays it back over time." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { title: "EMI", children: "EMI (Equated Monthly Instalment) is the fixed amount you pay every month to repay your loan. It includes both the loan amount and the interest." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { title: "Interest", children: "Interest is the extra money you pay for borrowing. It is the cost of the loan — the bank or scheme charges it for letting you use their money." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { title: "Moratorium", children: "Moratorium is a waiting period at the start when you do not have to pay the loan. But interest still adds up during this time, so the total you repay later is a little higher." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { title: "Working capital", children: "Working capital is the money you need to run the business day to day — buying stock, paying salaries, and covering daily costs before your sales bring money in." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { title: "Break-even", children: "Break-even is the sales level where your income just covers all your costs. Above this level you start making profit; below it you are losing money." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { title: "Subsidy", children: "A subsidy is money the government gives to help reduce your project cost. It is not a loan — you do not have to pay it back. It lowers how much you need to borrow or fund yourself." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExplainPanel, { title: "Collateral", children: "Collateral is something valuable you keep as a guarantee for a loan, like land or property. If you cannot repay, the lender can use it to recover the money." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-8 text-xs text-muted-foreground", children: [
          source === "backend" ? "Figures come from the live backend engine." : "Figures are estimates worked out from your inputs using fixed rules.",
          " ",
