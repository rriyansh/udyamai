import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useNavigate, S as Sparkles, T as TrendingUp } from "./index-CeuI7PIL.js";
import { B as Button, C as Card } from "./Card-DVJtgs4C.js";
import { D as DEMO_PROFILE } from "./demo-data-CVHFmdt3.js";
...
const BENEFITS = [
  {
    ...
    description: "See real demand, competition, and pricing for your business idea in your local area."
  },
  {
    icon: PiggyBank,
    title: "Plan your money",
    description: "Map your capital, costs, and profit so you know exactly what your business needs."
  },
  {
    icon: Landmark,
    title: "Find suitable financing",
    description: "Get matched to government schemes and loans that fit your situation."
  }
];
function CosmicMark({ size = "lg" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: `relative ${icon}`, "aria-hidden": true })
      ]
    }
  );
}
function LandingPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: !introDone ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(CosmicMark, { size: "lg" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center gap-1 text-center", children: VALUE_LINES.map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.p,
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto w-full max-w-6xl px-5 sm:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          className: "flex min-h-dvh flex-col justify-center py-16",
          "data-ocid": "hero_section",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid items-center gap-12 lg:grid-cols-2", children: [
              ...
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CosmicMark, { size: "sm" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-2xl font-bold tracking-tight text-foreground", children: "UdyamAI" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-8 font-display text-4xl font-bold leading-[1.05] tracking-tight text-foreground sm:text-5xl lg:text-6xl", children: [
                    "Your Local Business,",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Made Simple." })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground", children: "UdyamAI turns your business idea into a clear plan — showing you the market, your money, and the financing that fits. Built for rural entrepreneurs, in your language." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 inline-flex items-center gap-2 text-sm font-medium text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Clock3, { className: "size-4 text-primary", "aria-hidden": true }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                "aria-hidden": true,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex size-40 items-center justify-center rounded-full bg-gradient-primary text-primary-foreground shadow-elevated", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "size-14" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -inset-6 rounded-full bg-gradient-primary opacity-25 blur-2xl" })
                  ] }) }),
                  Array.from({ length: 12 }, (_, i) => `ray-${i}`).map((id2, i) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "pb-24", "data-ocid": "benefits_section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-2xl text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold tracking-tight text-foreground sm:text-4xl", children: "Everything you need to start right" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg text-muted-foreground", children: "Three clear steps take you from idea to a confident, funded plan." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3", children: BENEFITS.map((benefit, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "h-full p-6 transition-smooth hover:shadow-elevated", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex size-12 items-center justify-center rounded-xl bg-accent/15 text-accent-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "size-6", "aria-hidden": true }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-5 font-display text-lg font-semibold tracking-tight text-foreground", children: benefit.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm leading-relaxed text-muted-foreground", children: benefit.description })
              ] })
            },
            benefit.title
          );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border bg-card py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 px-5 text-sm text-muted-foreground sm:flex-row sm:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground", children: "UdyamAI" }),
